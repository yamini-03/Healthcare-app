...
export default function onlineappoint({navigation, route}) {

    LogBox.ignoreLogs(['Setting a timer']);

    const { Name, Academic, mode,ID } = route.params;
    // console.log("heyuidddd",ID);
    ...
    const successpage = (PatName) => {
        ...
        set(ref(db, 'Online_Appointments/' + PatienId + "/" + ID + "/" + AppointmentID), {
